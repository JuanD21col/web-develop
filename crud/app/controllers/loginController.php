                ...
                if($this->verificarDatos("[a-zA-Z0-9]{4,20}", $usuario)){
                    ...
                    if($this->verificarDatos("[a-zA-Z0-9$@.-]{7,100}", $clave)){
                        ...
                        if($check_usuario->rowCount()==1){
                            ...
                            if($check_usuario['usuario_usuario']
                            ==$usuario && password_verify($clave,
                            $check_usuario['usuario_clave'])){
                                ...
                                ['usuario_apellido'];
					            $_SESSION['usuario']=$check_usuario
                                ['usuario_usuario'];
					            $_SESSION['foto']=$check_usuario
                                ['usuario_foto'];

                                if(headers_sent()){
                                    echo "<script> window.location.href='"
                                    .APP_URL."dashboard/'; <script>";
                                }else{
